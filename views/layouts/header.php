                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +7 (380) 45-32-24</a></li>
                            <li><a href="/contacts/"><i class="fa fa-envelope"></i> eshopsupport@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="/cart/"><i class="fa fa-shopping-cart"></i> Корзина
                                (<span id="cart-count"><?php echo Cart::countCartItems(); ?></span>)
                                </a>
                            </li>
                            <?php if(!User::isGuest()):?>
